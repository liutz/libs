            ...
            if (camera != null) {
                ...
                try {
                    if (getHost().getRecordingHint() != CameraHost.RecordingHint.STILL_ONLY) {
                        ...
                        newSize = getHost().getPreferredPreviewSizeForVideo(getDisplayOrientation(), width, height,
                    ...
                    if (newSize == null || newSize.width * newSize.height < 65536) {
                        newSize = getHost().getPreviewSize(getDisplayOrientation(), width, height,
                                        camera.getParameters());
                    }
                } catch (Exception e) {
            ...
            if (camera != null && orientation != ORIENTATION_UNKNOWN) {
                ...
                if (newOutputOrientation != outputOrientation) {
                    ...
                    try {
                        ...
                        Log.e(getClass().getSimpleName(), "Exception updating camera parameters in orientation change",
                                        e);
